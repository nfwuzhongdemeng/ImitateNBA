...
public final class HttpLoggingInterceptor implements Interceptor {
    ...
    public Response intercept(Chain chain) throws IOException {
        ...
        //Level.HEADERS和Level.BODY打印header
        ...
        //LOG 请求方法（post/get等）+url+http版本+body长度
        ...
        //LOG 头部的Content-Type和Content-Length,未设置编码的设置编码格式为UTF8
        if (logHeaders) {
            if (hasRequestBody) {
